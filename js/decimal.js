...
//         } else {
//           // If the initial value is '0' and the entered value is a digit, replace the initial '0' with the entered digit
//           if (this.value === "0" && /^\d+$/.test(parts[0])) {
//             this.value = parts[0];
//           } else {
//             this.value = /^\d+$/.test(parts[0]) ? parts[0] : "0";
//           }
